# coppock_hill_vavreck_2020/download_original.R
...
#   against. md5_published is the checksum Dataverse displays. Here all 21 agree, but
...
#
#   One of the 21 files, ad_df.csv, was ingested by Dataverse into a tabular .tab
#   representation; the served_as column records the name Dataverse gives the derived
#   file. `?format=original` returns the deposited .csv bytes.
...
dataset_doi <- "doi:10.7910/DVN/TN7KWR"
